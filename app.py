...
col1.metric("Total Incidents", f"{int(total_incidents):,}")
col2.metric("Number of Provinces", total_provinces)
col3.metric("Average Incidents per Province", f"{avg_incidents:.0f}")
